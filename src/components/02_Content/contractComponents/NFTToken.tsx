...
export default function NFTToken(props: {setConnection: React.Dispatch<Action> })
{
    ...
    const [balance, nftToken, transactions] = useNFTToken(connection.account, connection.network.name, controller);
