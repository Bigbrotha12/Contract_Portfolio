...
export interface RegistrationInterface extends utils.Interface {
  functions: {
    ...
    "registerAndDeposit(address,uint256,bytes,uint256,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "registerAndDeposit(address,uint256,bytes,uint256,uint256)",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "registerAndDeposit(address,uint256,bytes,uint256,uint256,uint256)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
